        ...
        <div>
            <footer className="footer p-10 bg-neutral text-neutral-content mt-10">
                <aside className='mx-auto'>
                    <img src={logoPng} alt="Logo" className='max-h-48' />
                    {/* <p>MangoMart<br />Mangoes at your Doorstep</p> */}
                </aside>
            ...
            <footer className="footer footer-center p-4 bg-neutral text-white">
                <aside>
                    <p>Copyright © 2024 - All rights reserved by MangoMart Ltd</p>
                </aside>
            </footer>
        </div>
    );
